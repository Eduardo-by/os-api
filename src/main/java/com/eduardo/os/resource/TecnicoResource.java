...
import com.eduardo.os.service.TecnicoService;
...
public class TecnicoResource {
	...
	public ResponseEntity<java.util.List<TecnicoDTO>> findAll(){
		java.util.List<TecnicoDTO> listDTO = service.findAll().stream().map(obj -> new TecnicoDTO(obj)).collect(Collectors.toList());
